...
public class SelectPictureUtil {
    ...
    public void selectSinglePictyre(Activity activity) {
...
//                        .videoMinSecond(10)
    ...
    public void selectSinglePictyre(Fragment fragment) {
...
//                        .videoMinSecond(10)
    ...
    public void selectMultiplePictyre(Activity activity) {
        PictureSelector.create(activity)
                .openGallery(chooseMode)// 全部.PictureMimeType.ofAll()、图片.ofImage()、视频.ofVideo()、音频.ofAudio()
                .theme(R.style.picture_default_style)// 主题样式设置 具体参考 values/styles   用法：R.style.picture.white.style
                .maxSelectNum(maxSelectNum)// 最大图片选择数量
...
//                        .videoMinSecond(10)
    ...
    public void selectMultiplePictyre(Fragment fragment) {
        PictureSelector.create(fragment)
                .openGallery(chooseMode)// 全部.PictureMimeType.ofAll()、图片.ofImage()、视频.ofVideo()、音频.ofAudio()
                .theme(R.style.picture_default_style)// 主题样式设置 具体参考 values/styles   用法：R.style.picture.white.style
                .maxSelectNum(maxSelectNum)// 最大图片选择数量
