...
public class LoadingMoreFooter extends BaseMoreFooter {
    ...
    protected void initView() {
        ...
        layoutParams.setMargins((int) getResources().getDimension(com.zhouyou.recyclerviewsdk.R.dimen.textandiconmargin), (int) getResources().getDimension(com.zhouyou.recyclerviewsdk.R.dimen.textandiconmargin), (int) getResources().getDimension(com.zhouyou.recyclerviewsdk.R.dimen.textandiconmargin), (int) getResources().getDimension(com.zhouyou.recyclerviewsdk.R.dimen.textandiconmargin));
