...
public class NestedFixFlingScrollView extends FrameLayout implements NestedScrollingParent,
     ...
     *
     * <p>This version of the interfaces works on all versions of Android, back to API v4.</p>
     *
    ...
    public interface OnScrollChangeListener {
         ...
         */
        void onScrollChange(NestedFixFlingScrollView v, int scrollX, int scrollY,
    ...
    public NestedFixFlingScrollView(Context context) {
        this(context, null);
    }

    public NestedFixFlingScrollView(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public NestedFixFlingScrollView(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    static class AccessibilityDelegate extends AccessibilityDelegateCompat {
        ...
        public boolean performAccessibilityAction(View host, int action, Bundle arguments) {
            ...
            final NestedFixFlingScrollView nsvHost = (NestedFixFlingScrollView) host;
